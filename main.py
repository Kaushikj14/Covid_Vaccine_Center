...
if Total_centers != 0:
    ...
    print (f"Unfortunately !! Seems like no center in this area / Please enter another Pincode" )
...
# here {1:^12} here 1 represents current position, ^ REPRESENTS CENTERED ALLIGNMENT , 12 REPRESENTS TOTALSPACES